...
class Hestia_Big_Title_Controls extends Hestia_Register_Customizer_Controls {
	...
	public function init() {
		parent::init();
		$this->loader->add_filter( 'customizer_widgets_section_args', $this, 'move_widgets_section', 10, 3 );
	}
	...
	public function alignment_render_callback() {
		...
		$section_content        = $big_title_section_view->get_big_title_content();
		$big_title_section_view->show_big_title_content( $section_content );
	}
